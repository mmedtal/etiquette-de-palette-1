...
export default function Header(props){
    ...
    return(
        <div className="flex justify-around">
            <HeaderIcon disabled={true} text="Sélectionner" onClickDispatchActionsToReduxStore= {[{type:"SELECTIONNER"},{type:"AFFECTER_HAUTEUR",payload:0},{type:"AFFECTER_LARGEUR",payload:0} ]} >
